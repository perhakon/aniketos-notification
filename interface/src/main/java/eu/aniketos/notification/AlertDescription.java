...
/**
 * List of alert descriptions for use when invoking IAlert.alert()
 * The descriptions are equivalent to the changes and threats related to dynamic service composition 
 * and social processes, as described in section 3.2 of Aniketos deliverable D4.1.
 *
 * @version 1.0
 * @author Erlend Andreas Gjære (SINTEF), erlendandreas.gjare@sintef.no
 * @deprecated Rather use eu.aniketos.wp4.components.notification.taxonomy.ThreatLevelChange;
 */
